...
int main() {
	char out_keys[11 * 16] = {0}; // 16 bytes per key, 11 output keys per input key

	// Alla är 128-bit

	const char in_key_00[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	const char expanded_keys_00[] = {
	...
	const char in_key_ff[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
	const char expanded_keys_ff[] = {
	...
	const char in_key_in_order[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};
	const char expanded_keys_in_order[] = {
	...
	const char in_key_random[] = {0x69, 0x20, 0xe2, 0x99, 0xa5, 0x20, 0x2a, 0x6d, 0x65, 0x6e, 0x63, 0x68, 0x69, 0x74, 0x6f, 0x2a};
	const char expanded_keys_random[] = {
